...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildStatsCards(bool isDarkMode) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(child: _buildStatCard('📝', 'Reports', '$totalReports', isDarkMode)),
          const SizedBox(width: 12),
          Expanded(child: _buildStatCard('🔥', 'Streak', '$currentStreak days', isDarkMode)),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildActivityItem('📝', 'Total Reports', '$totalReports', isDarkMode),
          _buildActivityItem('🔥', 'Current Streak', '$currentStreak days', isDarkMode),
          _buildActivityItem('🏆', 'Longest Streak', '$longestStreak days', isDarkMode),
        ],
      ),
    );
  }
